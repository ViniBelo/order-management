...
@Schema(name = "ErrorResponse", description = "Standard API error payload returned by the application")
...
public record ErrorResponse(
    ...
    @Schema(description = "Validation details for field-level errors. Omitted when null.") List<ValidationError> errors
) {
